...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    String[] unsecuredResources = new String[] { "/*", "/assets/**", "/login", "/security/**", "/services/rest/login",
    ...
    "/services/rest/bookingmanagement/v1/invitedguest/decline/**", "/booking/acceptInvite/*", "/booking/rejectInvite/*",
    "booking/cancel/*", "booking/cancelOrder/*" };
