package com.devonfw.application.mtss4sdk.dishmanagement.logic.impl;
...
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.CategoryEntity;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.DishEntity;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.IngredientEntity;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.repo.CategoryRepository;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.repo.DishRepository;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.repo.IngredientRepository;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.Dishmanagement;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.CategoryEto;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.CategorySearchCriteriaTo;
...
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.DishSearchCriteriaTo;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.IngredientEto;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.IngredientSearchCriteriaTo;
import com.devonfw.application.mtss4sdk.general.logic.base.AbstractComponentFacade;
import com.devonfw.application.mtss4sdk.imagemanagement.logic.api.to.ImageEto;
