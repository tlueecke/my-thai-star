package com.devonfw.application.mtss4sdk.ordermanagement.logic.impl;
...
import com.devonfw.application.mtss4sdk.bookingmanagement.logic.api.Bookingmanagement;
import com.devonfw.application.mtss4sdk.bookingmanagement.logic.api.to.BookingCto;
import com.devonfw.application.mtss4sdk.bookingmanagement.logic.api.to.BookingEto;
import com.devonfw.application.mtss4sdk.bookingmanagement.logic.api.to.InvitedGuestEto;
import com.devonfw.application.mtss4sdk.dishmanagement.dataaccess.api.IngredientEntity;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.Dishmanagement;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.DishCto;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.DishEto;
import com.devonfw.application.mtss4sdk.dishmanagement.logic.api.to.IngredientEto;
import com.devonfw.application.mtss4sdk.general.common.api.constants.Roles;
import com.devonfw.application.mtss4sdk.general.logic.base.AbstractComponentFacade;
import com.devonfw.application.mtss4sdk.ordermanagement.common.api.exception.CancelNotAllowedException;
import com.devonfw.application.mtss4sdk.ordermanagement.common.api.exception.NoBookingException;
import com.devonfw.application.mtss4sdk.ordermanagement.common.api.exception.NoInviteException;
import com.devonfw.application.mtss4sdk.ordermanagement.common.api.exception.OrderAlreadyExistException;
import com.devonfw.application.mtss4sdk.ordermanagement.common.api.exception.WrongTokenException;
import com.devonfw.application.mtss4sdk.ordermanagement.dataaccess.api.OrderEntity;
import com.devonfw.application.mtss4sdk.ordermanagement.dataaccess.api.OrderLineEntity;
import com.devonfw.application.mtss4sdk.ordermanagement.dataaccess.api.repo.OrderLineRepository;
import com.devonfw.application.mtss4sdk.ordermanagement.dataaccess.api.repo.OrderRepository;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.Ordermanagement;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderCto;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderEto;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderLineCto;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderLineEto;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderLineSearchCriteriaTo;
import com.devonfw.application.mtss4sdk.ordermanagement.logic.api.to.OrderSearchCriteriaTo;
